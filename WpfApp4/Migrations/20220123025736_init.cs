        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Rubrik = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Beskrivning = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    skapades_date = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Andrades_Date = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobilNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
